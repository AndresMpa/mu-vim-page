---
title: Mu Vim
description: Three Vim/Neovim configs. VimScript, _current, and Mini.
permalink: /
---

<div class="mu-tree" aria-label="Mu Vim versions">
  <div class="mu-tree-root">Mu Vim</div>
  ...
  <div class="mu-tree-row">
    ...
    <div class="mu-tree-branch is-current">
      <a href="{{ '/lua/' | relative_url }}">_current</a>
    </div>
    <div class="mu-tree-branch">
...
<div class="home-copy">
  ...
  <p><a href="{{ '/lua/' | relative_url }}">_current</a> is the Lua core, Neovim only. Mason, Telescope, nvim-tree, and a chat bound to local Ollama. New work lands here first.</p>
